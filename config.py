...
CLICK_X_OFFSET = 25  # Offset cursor horizontally before clicking (pos right, neg left)
...
CONFIDENCE = 0.85  # The confidence with which LocateAllOnScreen() should search
